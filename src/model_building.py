...
class LinearRegressionStrategy(ModelBuildingStrategy):
    def build_and_train_model(
        ...
        Returns:
        Pipeline: A scikit-learn pipeline with a trained Linear Regression
        model.
...
class ModelBuilder:
    def __init__(self, strategy: ModelBuildingStrategy):
        ...
        Parameters:
        strategy (ModelBuildingStrategy): The strategy to be used for model
        building.
    ...
    def set_strategy(self, strategy: ModelBuildingStrategy):
        ...
        Parameters:
        strategy (ModelBuildingStrategy): The new strategy to be used for
        model building.
    ...
    def build_model(
        ...
        """
        logging.info(
            "Building and training the model using the selected strategy."
        )
