...
# -----------------------------------------------
# This class defines a common interface for different data splitting
# strategies.
...
class DataSplittingStrategy(ABC):
    ...
    def split_data(self, df: pd.DataFrame, target_column: str):
        ...
        Returns:
        X_train, X_test, y_train, y_test: The training and testing splits for
        features and target.
...
class SimpleTrainTestSplitStrategy(DataSplittingStrategy):
    ...
    def split_data(self, df: pd.DataFrame, target_column: str):
        """
        Splits the data into training and testing sets using a simple
        train-test split.
...
class DataSplitter:
    def __init__(self, strategy: DataSplittingStrategy):
        ...
        Parameters:
        strategy (DataSplittingStrategy): The strategy to be used for data
        splitting.
        """
    ...
    def set_strategy(self, strategy: DataSplittingStrategy):
        ...
        Parameters:
        strategy (DataSplittingStrategy): The new strategy to be used for data
        splitting.
        """
