...
class ZipDataIngestor(DataIngestor):
    def ingest(self, file_path: str) -> pd.DataFrame:
        ...
        # Find the extracted CSV file (assuming there is one CSV file inside
        # the zip)
...
if __name__ == "__main__":
    ...
    file_path = "//Users/georgensamuel/Documents/Machine_Learning_Projects/house_price_prediction/data/archive.zip"
